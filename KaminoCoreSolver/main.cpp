...
const size_t nx = 10;          // number of grid cells in u direction
const size_t ny = 10;          // number of grid cells in v direction
...
const float dt = 0.1;         // simulation time step size
const float DT = 1.0;    // framerate @ 24 fps = 0.0147
