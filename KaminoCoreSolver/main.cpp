...
const size_t nx = 20;          // number of grid cells in u direction
const size_t ny = 20;          // number of grid cells in v direction
...
const float dt = 0.01;         // simulation time step size
